...
FROM dblink('dbname=elearning port=5432 host=192.6.0.66 user=postgres password=BernardoCafe008','SELECT curso,profesor,fecha_registro FROM g_plannacer.cursos_profesores')
