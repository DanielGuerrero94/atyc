...
class seed_cursos_profesores extends Seeder
{
    /**
    ...
    public function run()
    {
        \DB::statement("INSERT INTO public.cursos_profesores (id,id_cursos,id_profesores,created_at)
(SELECT sub.id,sub.curso,sub.profesor,sub.fecha_registro
