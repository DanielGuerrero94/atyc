			...
			<form class="form" role="form">
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-7">
							<select class="form-control" id="tipo_doc" title="Documento nacional de identidad" value="{{$alumno->id_tipo_doc}}">
								@foreach ($documentos as $documento)
								
								<option value="{{$documento->id}}" title="{{$documento->titulo}}">{{$documento->nombre}}</option>
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-7">
							<select class="form-control" id="provincia" value="{{$alumno->id_provincia}}">
								...
								<option value="{{$provincia->id}}" title="{{$provincia->titulo}}">{{$provincia->nombre}}</option>	
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="col-xs-6">
							<select class="form-control" id="trabaja_en" value="{{$alumno->id_trabaja_en}}">

								@foreach ($trabajos as $trabajo)
								
								<option value="{{$trabajo->id}}" title="{{$trabajo->nombre}}">{{$trabajo->nombre}}</option>				 					
								@endforeach
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select class="form-control" id="funcion" value="{{$alumno->id_funcion}}">
								...
								<option value="{{$funcion->id}}" title="{{$funcion->nombre}}">{{$funcion->nombre}}</option>		
								@endforeach
