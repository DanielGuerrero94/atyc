            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="box box-info">
                        ...
                        <div id="filtros">
                            <div class="row">
                                <div class="form-group col-xs-12 col-sm-6">
                                    ...
                                    <div class="col-xs-8 col-sm-6">
                                        <select
                                                class="select-2 form-control anios" id="anios" name="id_anio"
                            ...
                            @if(Auth::user()->id_provincia == 25)
                                <div class="row">
                                    <div class="form-group col-xs-12 col-sm-6">
                                        <label
                                                for="provincia" class="control-label col-xs-4 col-sm-2"
                                        >Provincia:</label>
                                        <div class="col-xs-8 col-sm-6">
                                            <select
                                                    class="select-2 form-control provincias" id="provincias"
                                                    name="id_provincia" aria-hidden="true" multiple
                                            >
                    ...
                    <div class="box-footer">
                        <button class="btn btn-success pull-right" id="nueva_pauta"><i
                    ...
                    columns       : [{
                        ...
                        render        : function (data, type, row, meta) {
                            if (Object.entries(data[0]).length !== 0)
                                return data[0].map(function (anio) {
                                    return ' ' + anio.anio;
                                });
                        }
                    }, {
