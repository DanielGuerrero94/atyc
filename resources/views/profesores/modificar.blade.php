<div class="col-xs-12">
	<div class="box box-success">
			...
			<form id="form-alta">
				<div class="row">
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-xs-8">
							<select class="form-control" id="tipo_doc" title="Documento nacional de identidad" value="{{$profesor->id_tipo_doc}}">
		...
		<div class="box-footer">
			...
			<button class="btn btn-primary pull-right" id="modificar" title="Modificar" data-id="{{$profesor->id}}"><i class="fa fa-plus" aria-hidden="true"></i>Modificar</button>
		</div>
	</div> 
</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#alta').on('click','#modificar',function () {
			...
			var profesor = $('#alta #modificar').data('id');
