...
class DocentesTest extends TestCase
{
    ...
    public static function requestStore()
    {
        return array(
            array(new Request(
                    json_decode('{"nombres":"testA","apellidos":"testingA","nro_doc":"12345678","email":"testingA@testing.com","tel":"12345678","cel":"12345678","id_tipo_documento":"1","id_tipo_docente":"5"}',true)
                )
            ),
            array(new Request(
                    json_decode('{"nombres":"testB","apellidos":"testingB","nro_doc":"12345679","email":"testingB@testing.com","tel":"12345679","cel":"12345679","id_tipo_documento":"2","id_tipo_docente":"4"}',true)
                )
            )
        );
    }
