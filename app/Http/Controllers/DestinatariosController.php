        ...
        ->addColumn(
            ...
            function ($ret) {
                ...
                if($this->seCreoLaMismaSemana($ret))
                    $buttons .= '<a data-id="'.$ret->id_destinatario.'" class="btn btn-circle eliminar" '.
